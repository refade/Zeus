...
--------- | ------------- | ------------------ | -------------
Acronis | False Negative |False Negative |suspicious |
Ad-Aware | Trojan.Dropper.WYO |False Negative |Gen:Variant.Mikey.66498 |
AhnLab-V3 | Win-Trojan/Agent.700416.DW |False Negative |Spyware/Win32.Zbot.R25976 |
...
Bkav | W32.Common.82DFDB92 |W32.AIDetect.malware1 |False Negative |
...
CrowdStrike | win/malicious_confidence_90% (W) |False Negative |win/malicious_confidence_100% (W) |
...
eGambit | Unsafe.AI_Score_75% |False Negative |Unsafe.AI_Score_61% |
...
Gridinsoft | PWS.Win32.Zbot.cc!s1 |False Negative |Trojan.Win32.Downloader.sa |
...
Kingsoft | Win32.Troj.ZBot.sb.(kcloud) |Win32.Hack.Androm.a.(kcloud) |False Negative |
Lionic | Trojan.Win32.Zbot.tnc2 |Trojan.Win32.Androm.m!c |False Negative |
...
MaxSecure | False Negative |Win.MxResIcn.Heur.Gen |Trojan.Malware.4006265.susgen |
...
Paloalto | generic.ml |generic.ml |False Negative |
...
Rising | Trojan.Spy.Win32.Zbot.hli (CLOUD) |Worm.Win32.Gamarue.b (C64:YzY0OkPVd5YI2RWQ) |False Negative |
...
TotalDefense | Win32/Zbot.TFUCQRB |False Negative |False Negative |
...
ViRobot | Trojan.Win32.Agent.700416.U |False Negative |Trojan.Win32.A.Zbot.231424.I |
Webroot | False Negative |False Negative |W32.Bot.Gen |
...
Zoner | Trojan.Win32.23330 |False Negative |False Negative |
